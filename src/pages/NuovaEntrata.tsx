...
const mockFonti = [
  { id: "1", nome: "PostePay" },
  { id: "2", nome: "Hype" },
  { id: "3", nome: "Portafoglio" },
  { id: "4", nome: "Salvadanaio Camera" },
  { id: "5", nome: "Cassetto Cucina" },
];
...
const NuovaEntrata = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Nuova entrata:", nuovaEntrata);
    
    toast({
      title: "Entrata registrata",
      description: `€ ${parseFloat(formData.importo).toFixed(2)} aggiunti a ${mockFonti.find(f => f.id === formData.fonte)?.nome}`,
    });
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">Nuova Entrata</h1>
        ...
        <Card className="mt-6 bg-blue-50 border-blue-200">
          <CardContent className="p-4">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              <li>• Registra le entrate non appena possibile per tenere traccia precisa</li>
              <li>• Usa descrizioni chiare per identificare facilmente la fonte</li>
              <li>• Il portafoglio può ricevere denaro da altre fonti senza contare come nuova entrata</li>
            </ul>
          </CardContent>
        </Card>
      </div>
